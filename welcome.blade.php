            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <form class="form-inline" method="POST"   action="{{ route('api')}}">
                    ...
                    <div class="form-group">
                        <label for="inputPassword6">Начало периода</label>
                        ...
                        <small id="passwordHelpInline" class="text-muted">
                            Введите в формате <br> дд/мм/гггг
                        </small>
                        <label for="inputPassword6">Окончание периода</label>
                    ...
                    $(document).ready(function(){
                        ...
                        $(".form-inline").submit(function() {
                            ...
                            if(el_l.length < 1 || el_l2.length < 1){
                                ...
                                var $item = $('<div class="div" id="div">'+'заполните оба поля'+'</div>');
                                ...
                                var $item2 = $('<div class="div" id="div">'+'непозволительный символ' + '<br>' + 'введите период в формате: день/месяц/год '+'</div>');
                                ...
                                var $item3 = $('<div class="div" id="div">'+'непозволительный символ' + '<br>' + 'введите период в формате: день/месяц/год '+'</div>');
                        ...
                        Highcharts.chart('container', {
                            ...
                            series: [{
                                name: 'стоимость доллара в рублях',
